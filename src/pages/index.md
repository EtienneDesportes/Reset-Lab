...
sections:
  - type: hero_section
    content: >
      <h1 style="color:white; font-size:20pt;">Réparation d'électronique à Strasbourg</h1> <h1 style="color:white;
      font-size:16pt;">Spécialiste en micro soudure sur matériel
      informatique</h1> <h2 style="color:white ; font-size:16pt;">Réparation de
      carte-mère :</h2> <ul style="color:white"> <li>Dommage liquide</li>
  ...
  - type: grid_section
    ...
    grid_items:
      - title_align: center
        ...
        actions: []
        actions_align: left
        image: images/envoigratuit-69c13db7.svg
        image_position: top
        image_align: center
        image_has_padding: false
        image_alt: Réparation Imac
      - title_align: center
        ...
        actions: []
        actions_align: left
        image: images/réparation-32a3e815.svg
        image_position: top
        image_align: center
        image_has_padding: false
        image_alt: Réparation Macbook
  ...
  - type: cta_section
    content: >
      ...
      Nous sommes la pour vous aiguiller ! <div style="color:black;
      font-size:6pt;">https://www.jesuisreparateur.fr\</div>
    actions:
