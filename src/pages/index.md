...
sections:
  - type: hero_section
    content: >
      <h1 style="color:white; font-size:28pt;">Il reste une chance pour votre
      MacBook Ipad Imac Iphone</h1> <h1 style="color:white;
      font-size:18pt;">Nous sommes spécialistes en micro-soudure Apple </h1> <h2
      style="color:white ; font-size:16pt;">Réparations de carte-mère :</h2> <ul
      style="color:white"> <li>Dommage liquide</li> <li>Problème de
