...
sections:
  - type: hero_section
    content: >
      <h1 style="color:white; font-size:24pt;">Réparation iPhone, iMac, MacBook,
      iPad</h1> <h1 style="color:white; font-size:18pt;">Nous sommes spécialisés
      en micro soudure d'électronique !</h1> <h2 style="color:white ;
