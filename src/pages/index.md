...
sections:
  - type: hero_section
    content: >
      <h1 style="color:black; font-size:24pt;">Réparation Informatique &
      Electronique (MacBook, iMac, iPad, PC portable,...)</h1> <h1
      style="color:black; font-size:18pt;">Nous sommes spécialisés en micro
      soudure</h1> <h2 style="color:black ; font-size:16pt;">Réparations de
      carte-mère :</h2> <ul style="color:black"> <li>Dommage liquide</li>
      <li>Problème de démarrage</li> <li>Récupération de données</li>
      <li>Changement de composants</li></ul> 
    actions:
    ...
    has_border: true
    background_image: images/background4-min(13).jpg
  - type: grid_section
    subtitle: ''
    grid_items:
      - title_align: center
        ...
        image: images/devisgratuit-bd48db1c.svg
      - title_align: center
        content: >
      ...
      - title_align: center
        ...
        image_width: twenty-five
        image: images/garantie-8c77c000.svg
    grid_cols: three
  ...
  - type: grid_section
    ...
    grid_items:
      ...
      - title_align: center
        ...
        actions: []
        actions_align: left
        image: images/réparation-cff33f97.svg
        image_position: top
        image_align: center
        image_has_padding: false
        image_alt: Réparation Macbook Nantes
