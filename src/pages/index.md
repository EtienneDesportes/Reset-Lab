...
sections:
  - type: hero_section
    content: >
      <h1 style="color:black; font-size:20pt;">Réparation d'électronique à Strasbourg</h1> <h1 style="color:black;
      font-size:16pt;">Spécialiste en micro soudure sur matériel
      informatique</h1> <h2 style="color:black ; font-size:16pt;">Réparation de
